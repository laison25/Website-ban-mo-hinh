CREATE DATABASE IF NOT EXISTS website_ban_mo_hinh CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
('Eevee Evolution Statue', 'Nendoroid', 'Dream Resin', 'Bản tượng Eevee cùng dàn tiến hóa với bố cục lớn, màu sắc bắt mắt, phù hợp dùng làm banner hoặc trang đăng nhập.', 5200000, 6100000, 4, 5, 120, 'EEVEE-001', 'H: 38cm', 'assets/images/products/product-2.svg', 1),
